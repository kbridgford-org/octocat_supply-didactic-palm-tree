...
The repository has an organization ruleset [OD OctoCAT Supply Ruleset](https://github.com/organizations/octodemo/settings/rules/8545588) applied, setting up a few of the standard rules like:
